class Staff::PlansController < ApplicationController
  ...
  def permitted_params
    @permitted_params ||= params[:plan].present? ? params.require(:plan).permit(:program_id, :display_name, :days_per_week, :price, :plan_type, :monday, :tuesday, :wednesday, :thursday, :friday, :saturday, :sunday) : {}
  end
end
